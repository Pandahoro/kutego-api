...
func NewKutegoAPIAPI(spec *loads.Document) *KutegoAPIAPI {
	return &KutegoAPIAPI{
		...
		GetCatNameHandler: GetCatNameHandlerFunc(func(params GetCatNameParams) middleware.Responder {
			return middleware.NotImplemented("operation GetCatName has not yet been implemented")
		}),
		GetCatRandomHandler: GetCatRandomHandlerFunc(func(params GetCatRandomParams) middleware.Responder {
			return middleware.NotImplemented("operation GetCatRandom has not yet been implemented")
		}),
		GetCatsHandler: GetCatsHandlerFunc(func(params GetCatsParams) middleware.Responder {
			return middleware.NotImplemented("operation GetCats has not yet been implemented")
		}),
...
type KutegoAPIAPI struct {
	...
	// GetCatNameHandler sets the operation handler for the get cat name operation
	GetCatNameHandler GetCatNameHandler
	// GetCatRandomHandler sets the operation handler for the get cat random operation
	GetCatRandomHandler GetCatRandomHandler
	// GetCatsHandler sets the operation handler for the get cats operation
	GetCatsHandler GetCatsHandler
...
func (o *KutegoAPIAPI) Validate() error {
	...
	if o.GetCatNameHandler == nil {
		unregistered = append(unregistered, "GetCatNameHandler")
	}
	if o.GetCatRandomHandler == nil {
		unregistered = append(unregistered, "GetCatRandomHandler")
	}
	if o.GetCatsHandler == nil {
		unregistered = append(unregistered, "GetCatsHandler")
	}
...
func (o *KutegoAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/cat/{name}"] = NewGetCatName(o.context, o.GetCatNameHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/cat/random"] = NewGetCatRandom(o.context, o.GetCatRandomHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/cats"] = NewGetCats(o.context, o.GetCatsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
